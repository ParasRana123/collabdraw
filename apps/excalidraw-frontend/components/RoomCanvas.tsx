...
export function RoomCanvas({ roomId } : {roomId: string}) {
    ...
    useEffect(() => {
        const ws = new WebSocket(`${WS_URL}?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjMsImlhdCI6MTc2MTQyMDE2OH0.ltA6f4St0jjHwuOAjZSGelr5JuBlzfAU9ycO9QuB9l4`);
    ...
    return <div>
        ...
        <button style={{
                ...
                cursor: 'pointer',
                transition: 'background-color 0.3s'
        }} onClick={() => { (shape !== "rhombus")? setShape("rhombus") : setShape("null")}}>Diamond</button>
        <button style={{
            cursor: 'pointer',
            borderRadius: "4px",
            padding: "6px 12px",
